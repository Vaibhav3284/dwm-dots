...
keymap.set("n", "<C-Left>", "<C-w>h", opts)  -- h - Navigate Right
keymap.set("n", "<C-Down>", "<C-w>j", opts)  -- j - Navigate Down
keymap.set("n", "<C-Up>", "<C-w>k", opts)    -- k - Navigate Up
keymap.set("n", "<C-Right>", "<C-w>l", opts) -- l - Navigate Left

-- * Nvim Pane Navigation: Ctrl + h/j/k/l
keymap.set("n", "<C-h>", "<C-w>h", opts) -- h - Navigate Right
keymap.set("n", "<C-j>", "<C-w>j", opts) -- j - Navigate Down
keymap.set("n", "<C-k>", "<C-w>k", opts) -- k - Navigate Up
keymap.set("n", "<C-l>", "<C-w>l", opts) -- l - Navigate Left
